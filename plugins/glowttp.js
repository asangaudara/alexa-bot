...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'glow ?(.*)', fromMe: true, desc: Lang.GLOW_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'glow ?(.*)', fromMe: false, desc: Lang.GLOW_DESC }, (async (message, match) => {
