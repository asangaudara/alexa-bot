...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'wall', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'wall', fromMe: false, desc: Lang.WP}, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid, Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '⚜Made by :- *Asanga Udara*⚜'})
